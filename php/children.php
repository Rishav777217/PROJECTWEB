...
<a href="flip.php" style="color:white; text-decoration:none; background-color:blue; border-radius:10px; padding:20px;" >HOME</a>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="images/kids1.jpg"  style="width:82%;" alt="shirt">
      <div class="container">
        <h2>Party Wear</h2>
        <p class="title">Extra 10% off on using visa</p>
         <p style="font-weight:bold; font-size:28px;"> <strike>600</strike> RS.300 50% off</p>
        <p>pure cotton</p>
  ...
  <div class="column">
    <div class="card">
      <img src="images/kids2.jpg" alt="girl child casual wear" style="width:36%">
      <div class="container">
        <h2>Casual wear</h2>
        <p class="title">niles</p>
         <p style="font-weight:bold; font-size:28px;"> <strike>700</strike> RS.350  50% off</p>
        <p>cotton material</p>
        <p><input type="submit" class="button" value="BUY NOW" onclick="move();"></p>
      </div>
    </div>
...
<div class="column">
    <div class="card">
      <img src="images/kids3.jpg" alt="traditional wear" style="width:54%">
      <div class="container">
        <h2>Traditional Wear</h2>
        <p class="title"> Levi</p>
        <p style="font-weight:bold; font-size:28px;"> <strike>1000</strike> RS.500 50% off</p>
        <p>Slim fit</p>
        <p><input type="submit" class="button" value="BUY NOW" onclick="move();"></p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      <img src="images/kids4.jpg" alt="party wear" style="width:54%">
      <div class="container">
        <h2>Party Wear</h2>
        <p class="title">Raymond</p>
        <p style="font-weight:bold; font-size:28px;"> <strike>800</strike> <span id="watch">RS.400 </span> 50% off</p>
        <p>resistant</p>
        <p><input type="submit" class="button" value="BUY NOW" onclick="move();"></p>
      </div>
    </div>
