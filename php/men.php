...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="images/men1.jpg"  style="width:48%;" alt="shirt">
      <div class="container">
        <h2>Raymond Party wear</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="images/men2.jpg" alt="shirt" style="width:62%">
      <div class="container">
        <h2>Casual shirt</h2>
        <p class="title">Peter England</p>
         <p style="font-weight:bold; font-size:28px;"> <strike>2000</strike> RS.1000  50% off</p>
        <p>cotton material</p>
        <p><input type="submit" class="button" value="BUY NOW" onclick="move();"></p>
      </div>
    </div>
...
<div class="column">
    <div class="card">
      <img src="images/men4.jpg" alt="jeans" style="width:60%">
      <div class="container">
        <h2>Jeans</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="images/men5.jpg" alt="jeans" style="width:60%">
      <div class="container">
        <h2>Party Jeans</h2>
